...
class TestScript(unittest.TestCase):
    ...
    def test_step(self):
        ...
        Wallet(DUT).inputInformation("n1JEBqmiMeVyiD6a5Qsa6eFktWV2UAFkyZz","0.000000000000000001","jdjjdjdjd")
        ...
        Common(DUT).goBack()
        Common(DUT).clickByText("转账")
        Wallet(DUT).inputInformation("n1JEBqmiMeVyiD6a5Qsa6eFktWV2UAFkyZz", "0.000000000000000001", "jdjjdjdjd","default", "ATP")
        Wallet(DUT).chooseWallet("钱包 1")
        Common(DUT).wait(3)
